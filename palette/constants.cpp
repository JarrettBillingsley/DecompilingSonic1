...
{
	{ 0x0400, 0x0600, 0x0620, 0x0624, 0x0664, 0x0666 },
	{ 0x0600, 0x0820, 0x0A64, 0x0A68, 0x0AA6, 0x0AAA },
	{ 0x0800, 0x0C42, 0x0E86, 0x0ECA, 0x0EEC, 0x0EEE },
	{ 0x0400, 0x0420, 0x0620, 0x0620, 0x0864, 0x0666 },
	{ 0x0420, 0x0620, 0x0842, 0x0842, 0x0A86, 0x0AAA },
	{ 0x0620, 0x0842, 0x0A64, 0x0C86, 0x0EA8, 0x0EEE },
};

// The final game only uses the first two entries of this palette (bright green and bright blue) for the birds/fish.
// The third, fourth, and fifth entries are unused, but contain completely valid palettes of muted green, purple, and
// muted blue. v_palss_bgpalselect controls which palettes are selected. The final never changes this from 0, but 1, 2,
// and 3 are valid values as well.
const ushort Pal_SSCyc2[][][] =
{
	{
		{ 0x0EEA, 0x0EE0, 0x0AA0, 0x0880, 0x0660, 0x0440 },
		{ 0x0EE0, 0x0AA0, 0x0440 },
		{ 0x0AA0, 0x0AA0, 0x0AA0 },
		{ 0x0860, 0x0860, 0x0860 },
		{ 0x0640, 0x0640, 0x0640 },
		{ 0x0400, 0x0400, 0x0400 },
	},
	{
		{ 0x0AEC, 0x06EA, 0x04C6, 0x02A4, 0x0082, 0x0060 },
		{ 0x06EA, 0x04C6, 0x0060 },
		{ 0x04C6, 0x04C6, 0x04C6 },
		{ 0x0484, 0x0484, 0x0484 },
		{ 0x0442, 0x0442, 0x0442 },
		{ 0x0400, 0x0400, 0x0400 },
	},
	{
		{ 0x0ECC, 0x0E8A, 0x0C68, 0x0A46, 0x0824, 0x0602 },
		{ 0x0E8A, 0x0C68, 0x0602 },
		{ 0x0C68, 0x0C68, 0x0C68 },
		{ 0x0846, 0x0846, 0x0846 },
		{ 0x0624, 0x0624, 0x0624 },
		{ 0x0400, 0x0400, 0x0400 },
	},
	{
		{ 0x0AEC, 0x08CA, 0x06A8, 0x0486, 0x0264, 0x0042 },
		{ 0x08CA, 0x06A8, 0x0042 },
	...
	{
		{ 0x0EEC, 0x0CCA, 0x0AA8, 0x0886, 0x0664, 0x0442 },
		{ 0x0CCA, 0x0AA8, 0x0442 },
		{ 0x0AA8, 0x0AA8, 0x0AA8 },
		{ 0x0864, 0x0864, 0x0864 },
